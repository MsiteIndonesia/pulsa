(function ($) {
    ...
    var generateErrorBox = function(text){
        return '<div class="twit-fetcher-errorBox"><img class="twit-fetcher-close" src="images/icons/closeIcon.png" alt="Close"/><p>' + text + '</p></div>';
    };

    var generateSpinner = function(){
        return '<div class="twit-fetcher-spinner"><img src="assets/images/spinner.gif" alt="Loading..."/></div>';
    };
        ...
        for (var i = 0; i < a.length; i++) {
            ...
            if (settings.enablePermalink === true) {
                html += '<a class="permalink" href="' + p[i] + '">\n' +
                    '<span class="twt-date"><i class="fa fa-clock-o" aria-hidden="true"></i> ' + d[i] + '</span>\n' +
                    '</a>\n' + 
					'<i class="fa fa-twitter" aria-hidden="true"></i>';
            }
            else {
                html += '<span class="twt-date"><i class="fa fa-clock-o" aria-hidden="true"></i> ' + d[i] + '</span>\n' + '<i class="fa fa-twitter" aria-hidden="true"></i>';
            }
            html += '</div>\n' +
                '</div>\n' +
                '<div class="twt-row row">\n' +
